	...
	return (
		<div className="min-w-screen dark:bg-background/60 relative min-h-screen bg-white/10 py-10 backdrop-blur-md">
			<div className="pointer-events-none absolute inset-0">
				...
				<div className="from-chuni-violet-400/25 via-chuni-lavender-400/20 absolute -right-32 top-1/3 h-80 w-80 rounded-full bg-gradient-to-br to-transparent blur-3xl" />
				<div className="from-chuni-green-400/20 via-chuni-mint-300/15 absolute -bottom-24 left-1/3 h-64 w-64 rounded-full bg-gradient-to-br to-transparent blur-3xl" />
			</div>
