...
export default function Home() {
	return (
		<div className="relative min-h-screen w-full overflow-hidden border-t bg-white/10 px-8 py-10 dark:bg-background/70">
			<div className="container relative mx-auto px-4 py-16">
				<div className="mx-auto max-w-4xl">
					<div className="mb-12 text-center">
						...
						<div className="mx-auto h-1 w-24 rounded-full bg-linear-to-r from-chuni-mint-500 via-chuni-sky-500 to-chuni-violet-500 opacity-80"></div>
					</div>
					...
					<div className="relative w-full rounded-2xl border border-white/40 bg-white/25 px-8 py-10 shadow-[0_20px_60px_-30px_rgba(15,23,42,0.45)] backdrop-blur-2xl transition-all duration-300 dark:border-white/10 dark:bg-white/5">
						...
						<div className="pointer-events-none absolute inset-0 rounded-2xl bg-linear-to-br from-white/30 via-white/10 to-transparent opacity-70 dark:from-white/10 dark:via-transparent" />
						<h1 className="relative mb-6 text-3xl font-bold text-gray-900 dark:text-white">
							<span className="bg-linear-to-r from-chuni-violet-500 via-pink-400 to-chuni-mint-600 bg-clip-text text-transparent">
								X-VERSE 대응 업데이트 완료
							</span>
						</h1>
						<div className="relative space-y-6 leading-relaxed text-gray-700 dark:text-gray-200">
							<div className="flex items-start space-x-3">
								<div className="mt-3 h-2 w-2 shrink-0 rounded-full bg-linear-to-r from-chuni-mint-500 to-chuni-green-500"></div>
								<p className="text-lg">
									ChuniLink는 현재{' '}
							...
							<div className="flex items-start space-x-3">
								<div className="mt-3 h-2 w-2 shrink-0 rounded-full bg-linear-to-r from-chuni-lavender-400 to-chuni-violet-500"></div>
								<p className="text-lg">
